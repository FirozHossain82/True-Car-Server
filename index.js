...
// mongodb+srv://<username>:<password>@cluster0.krqmuiy.mongodb.net/?retryWrites=true&w=majority

const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });

// client.connect(err => {
//     const collection = client.db("true-car").collection("devices");
...
async function run(){
    try{
        ...
        const bookingsCollection = client.db('usedCar').collection('bookings');
